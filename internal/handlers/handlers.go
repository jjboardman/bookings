...
import (
	...
	"github.com/jjboardman/bookings/internal/models"
...
// Queens renders the queens page
func (m *Repository) Queens(w http.ResponseWriter, r *http.Request) {
	render.RenderTemplate(w, r, "queens.page.tmpl", &models.TemplateData{})
}
